...
use DuplicatorPro\Aws\Common\Enum\UaString as Ua;
use DuplicatorPro\Aws\S3\Exception\InvalidArgumentException;
use DuplicatorPro\Aws\S3\Exception\DeleteMultipleObjectsException;
use DuplicatorPro\Guzzle\Batch\BatchTransferInterface;
 ...
 * single request
 */
class DeleteObjectsTransfer implements BatchTransferInterface // @phpstan-ignore-line
{
    /**
