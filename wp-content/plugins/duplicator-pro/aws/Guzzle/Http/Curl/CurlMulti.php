...
use DuplicatorPro\Guzzle\Http\Exception\MultiTransferException;
...
use DuplicatorPro\Guzzle\Http\Exception\RequestException;
...
class CurlMulti extends AbstractHasDispatcher implements CurlMultiInterface
{
    ...
    {
        if (\DUP_PRO_U::isCurlResourceOrInstance($this->multiHandle)) {
