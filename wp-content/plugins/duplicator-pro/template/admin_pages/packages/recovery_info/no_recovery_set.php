...
<ol>
    <li>
        <?php _e('Select a recovery package with the icon <i class="fas fa-undo-alt fa-sm fa-fw"></i> displayed*.', 'duplicator-pro'); ?>
    </li>
    <li>
...
<small>
    <i>
        <?php
        echo __('*Note: If you do not see a recovery package <i class="fas fa-undo-alt"></i> icon in the packages list.', 'duplicator-pro') . ' ' .
