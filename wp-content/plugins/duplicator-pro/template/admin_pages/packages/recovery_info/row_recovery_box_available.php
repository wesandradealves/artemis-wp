...
$tooltipContent = __('This action will set this package as the active recovery point and launch the recovery installer wizard.', 'duplicator-pro') . ' ' .
    __('The installer will walk you through the restore process step by step.', 'duplicator-pro');
?>
...
<div class="dup-dlg-recover">
    ...
    <i  class="fas fa-question-circle fa-sm dup-base-color"
        ...
        data-tooltip="<?php esc_attr($tooltipContent); ?>"
        aria-expanded="false">
    </i>
</div>
