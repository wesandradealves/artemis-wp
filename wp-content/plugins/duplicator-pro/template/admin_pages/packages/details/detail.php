...
<div class="dup-package-details-wrapper">
    <div class="toggle-box">
        <a href="javascript:void(0)" onclick="DupPro.Pack.OpenAll()">
            [<?php DUP_PRO_U::esc_html_e('open all'); ?>]
        </a> &nbsp;
        <a href="javascript:void(0)" onclick="DupPro.Pack.CloseAll()">
            [<?php DUP_PRO_U::esc_html_e('close all'); ?>]
        </a>
    </div>
        ...
        <table class='dup-dtl-data'>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="dup-link-data dup-link-data-versions">
                        <b><?php DUP_PRO_U::esc_html_e("WordPress") ?>:</b> 
                            <?php echo strlen($package->VersionWP) ? esc_html($package->VersionWP) : DUP_PRO_U::esc_html__("- unknown -") ?><br/>
                        <b><?php DUP_PRO_U::esc_html_e("PHP") ?>:</b> 
                            <?php echo strlen($package->VersionPHP) ? esc_html($package->VersionPHP) : DUP_PRO_U::esc_html__("- unknown -") ?><br/>
                        <b><?php DUP_PRO_U::esc_html_e("OS") ?>:</b> 
                            <?php echo strlen($package->VersionOS) ? esc_html($package->VersionOS) : DUP_PRO_U::esc_html__("- unknown -") ?><br/>
            ...
            <tr>
                ...
                <?php if ($package->Status != DUP_PRO_PackageStatus::ERROR) : ?>
                    <?php if ($package->haveLocalStorage() && $archive_exists) : ?>
                        <button 
    ...
    <div id="dup-dlg-quick-path" title="<?php DUP_PRO_U::esc_attr_e('Download Links'); ?>" style="display:none">
        ...
        <div style="padding: 0px 15px 15px 15px;">
            ...
            >
                [<?php DUP_PRO_U::esc_html_e('Select & Copy'); ?>]
            </a><br/>
                        ...
                        <tr class="sub-item">
                            ...
                            <td>
                                ...
                                echo ($package->Installer->OptsCPNLDBAction == 'create') ?
                                    DUP_PRO_U::__("Create A New Database") :
                                    DUP_PRO_U::__("Connect to Existing Database and Remove All Data");
                                ?>
                            </td>
                        </tr>
                        <tr class="sub-item">
    ...
    <?php if ($global->debug_on) : ?>
        <div style="margin:0">
            <a href="javascript:void(0)" onclick="jQuery(this).parent().find('.dup-pack-debug').toggle()">
                [<?php DUP_PRO_U::esc_html_e("View Package Object") ?>]
            </a><br/>
