...
<div id="tabs-1">
    ...
    if (InstState::isAddSiteOnMultisiteAvaiable()) {
        ?>
        <div 
    ...
    <?php }
    if (InstState::isMultisiteInstallAvaiable() && !InstState::dbDoNothing()) {
        ?>
        <div 
            id="url-multisite-mapping-wrapper" 
            class="margin-top-1 <?php echo InstState::isMultisiteInstall() ? '' : 'no-display'; ?> requires-db-hide"
        >
