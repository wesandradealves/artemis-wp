...
if (InstState::instTypeAvaiable(InstState::TYPE_RBACKUP_SINGLE)) {
    $instTypeClass = 'install-type-' . InstState::TYPE_RBACKUP_SINGLE;
    $title         = 'Restore - Single Site Backup';
} elseif (InstState::instTypeAvaiable(InstState::TYPE_RBACKUP_MSUBDOMAIN)) {
    $instTypeClass = 'install-type-' . InstState::TYPE_RBACKUP_MSUBDOMAIN;
    $title         = 'Restore - Multisite-Subdomain Backup';
} elseif (InstState::instTypeAvaiable(InstState::TYPE_RBACKUP_MSUBFOLDER)) {
