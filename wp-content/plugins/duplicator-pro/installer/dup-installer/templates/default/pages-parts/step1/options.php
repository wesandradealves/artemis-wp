...
<div id="step1-options-wrapper" class="hdr-sub1-area tabs-area no-display">
    <div class="tabs">
        <ul>
            <li><a id="label-for-advanced" href="#tabs-advanced">Advanced</a></li>
            <li class="requires-db-hide"><a href="#tabs-database">Database</a></li>
            <li class="requires-db-hide"><a href="#tabs-other">URLs & Paths</a></li>
        </ul>
