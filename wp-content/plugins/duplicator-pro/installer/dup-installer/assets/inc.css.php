...
input:not([type=checkbox]):not([type=radio]):not([type=button]):not(.select2-search__field),
select {
    min-width: 0;
    width: 100%;
    border-radius: 2px;
...
input:not([type=checkbox]):not([type=radio]):not([type=button]).w30,
select.w30 {
    width: 30%;
}

input:not([type=checkbox]):not([type=radio]):not([type=button]).w50,
select.w50 {
    width: 50%;
}

input:not([type=checkbox]):not([type=radio]):not([type=button]).w95,
select.w95 {
    width: 95%;
}
...
.overwrite_sites_list .overwrite_site_item {
    display: flex;
    flex-wrap: wrap;
    gap: 5px 20px;
}

.overwrite_sites_list .overwrite_site_item .del_item {
    float: right;
    font-size: 25px;
    line-height: 1;
}

.overwrite_sites_list .overwrite_site_item .del_item.disabled {
    color: silver;
}


.overwrite_sites_list .overwrite_site_empty_list_msg .fas,
  {
    font-size: 20px;
    float: left;
    margin-right: 5px;
...
.overwrite_sites_list .overwrite_site_item > .col {
    flex: 1 1 0;
}
.overwrite_sites_list .overwrite_site_item.title > .col {
    border-bottom: 1px solid #D3D3D3;
    padding-bottom: 5px;
    font-weight: bold;
}

.overwrite_sites_list .overwrite_site_item > .col.del {
    flex-grow: 0;
    font-size: 18px;
}

.overwrite_sites_list .overwrite_sites_list.no-multiple .overwrite_site_item > .col.del,
.overwrite_sites_list .overwrite_sites_list.no-multiple .overwrite_site_item.add_item {
    display: none;
}

.overwrite_sites_list .overwrite_site_item > .full {
    flex: 0 0 100%;
}

.overwrite_sites_list .target_select_wrapper {
    position: relative;
}

.overwrite_sites_list .target_select_wrapper .new-slug-wrapper {
    position: absolute;
    top: 0;
    right: 22px;
    width: 280px;
...
.overwrite_sites_list .target_select_wrapper .new-slug-wrapper  input {
    background: #EFEFEF;
    border-radius: 0;
}
...
#header-main-wrapper .hdr-secodary .wiz-dupx-version {
    padding: 0;
}
...
STEP 1 VIEW
 ==================================================================================== */
.overview-description> :first-child {
    margin-top: 0;
}
...
.box.warning .overview-description h2::before {
    content: "\f071";
    margin-right: 5px;
    font-family: "Font Awesome 5 Free";
    color: maroon;
...
.overview-description .details table td {
    padding: 4px
}

.overview-description .details table td:first-child {
    display: inline-block;
    width: 75px;
    font-weight: bold
}
...
#overview-description-wrapper .help-icon {
    position: absolute;
    right: 20px;
}
...
#s1-area-archive-file .ui-widget.ui-widget-content {
...
.validation-results thead tr {
    font-weight: bold;
    background-color: #FFFFFF;
}

.validation-results thead tr td {
    padding: 10px 5px;
}
...
.s1-validate-sub-status td:first-child {
    font-weight: bold
}

.s1-validate-sub-status td {
    padding: 1px 5px 1px 5px
}

.s1-validate-sub-status td small {
    font-weight: normal
}
...
.s1-checks-area td.title {
    font-size: 16px;
    width: 100%
}

.s1-checks-area td.title small {
    font-size: 11px;
    font-weight: normal
}

.s1-checks-area td.toggle {
    font-size: 11px;
    margin-right: 7px;
    font-weight: normal
}
...
input#accept-warnings,
div.s1-accept-check input[type=checkbox] {
    height: 17px;
    width: 17px
}

div#wrapper_item_accept-warnings {
    margin-left: 30px
}
...
td#cpnl-prefix-dbname {
    width: 10px
}

td#cpnl-prefix-dbuser {
    width: 10px;
    white-space: normal
}

div#s2-cpnl-area div#cpnl-host-warn {
    white-space: normal;
    font-size: 11px;
    display: none;
    font-style: italic
...
a#s2-cpnl-status-msg {
    font-size: 11px
}

span#s2-cpnl-status-icon {
    display: none
}
...
div#cpnl-dbname-prefix {
    display: none;
    float: left;
    margin-top: 3px;
}

span#s2-cpnl-db-opts-lbl {
    font-size: 11px;
    font-weight: normal;
    font-style: italic
}

div#s2-cpnl-dbname-area2 table {
    border-collapse: collapse;
    width: 100%
}

div#s2-cpnl-dbname-area2 table td {
    padding: 0 !important;
    margin: 0;
    border: 0
}

div#s2-cpnl-dbname-area2 table td:first-child {
    vertical-align: bottom;
}

div#s2-cpnl-dbname-area2 table td:nth-child(2) {
    width: 100%;
    padding-right: 0 !important
}

div#s2-cpnl-dbuser-area2 table {
    border-collapse: collapse;
    width: 100%
}

div#s2-cpnl-dbuser-area2 table td {
    padding: 0 !important;
    margin: 0;
    border: 0
}

div#s2-cpnl-dbuser-area2 table td:first-child {
    vertical-align: bottom;
}

div#s2-cpnl-dbuser-area2 table td:nth-child(2) {
    width: 100%;
    padding-right: 0 !important
}
...
.s2-dbtest-area input[type=button] {
    font-size: 11px;
    height: 20px;
    border: 1px solid gray;
    border-radius: 3px;
...
.s2-dbtest-area div.sub-message {
    padding: 5px;
    text-align: center;
    font-style: italic;
    color: maroon
...
.s2-dbtest-area div.error-msg {
    color: maroon
}

.s2-dbtest-area div.success-msg {
    color: green
}
...
table tr.param_item_tables_item {
    font-size: 12px;
    font-family: monospace
}
...
button#select-all-plugins {
    padding: 1px;
    cursor: pointer
}

button#unselect-all-plugins {
    padding: 1px;
    cursor: pointer
}
...
table.s4-report-results tr:hover .count {
    font-weight: bold;
}
...
/*Used to hide Lite only content */
.hlp-lite-hide {
    display: none
}
