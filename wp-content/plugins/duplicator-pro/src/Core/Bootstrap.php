...
class Bootstrap
{
    ...
    protected static function dailyActions()
    {
        ...
        try {
            ...
            StoragesUtil::purgeOldS3MultipartUploads();
    ...
    public static function menu()
    {
        ...
        $pacakgeScreen = new PackageScreen($page_packages); // Init hook on constructor
    ...
    public static function adminFooterText()
    {
        $text = sprintf(
            wp_kses(
                _x(
                    'Please rate <strong>Duplicator</strong> %1$s on %2$sWordPress.org%3$s to help us spread the word. Thank you from the Duplicator team!',
            ...
            '<a href="https://wordpress.org/support/plugin/duplicator/reviews/?filter=5#new-post" target="_blank" rel="noopener noreferrer">' .
            '&#9733;&#9733;&#9733;&#9733;&#9733;</a>',
            '<a href="https://wordpress.org/support/plugin/duplicator/reviews/?filter=5#new-post" target="_blank" rel="noopener">',
            '</a>'
        );
