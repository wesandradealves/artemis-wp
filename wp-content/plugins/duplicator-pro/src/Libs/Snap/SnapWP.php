...
class SnapWP
{
     ...
     * @return string
     */
    public static function adminUrl($path = '', $data = array(), $scheme = 'admin')
    {
        $data = (array) $data;
    ...
    public static function getMainSiteId($network_id = null)
    {
        ...
        $network = function_exists('get_network') ?
            ...
            wp_get_network($network_id); // phpcs:ignore WordPress.WP.DeprecatedFunctions.wp_get_networkFound
        if (!$network) {
            return 0;
        }
    ...
    public static function getSites($args = array())
    {
        ...
        if (function_exists('get_sites')) {
            ...
            $result    = array();
            $blogs     = wp_get_sites($args); // phpcs:ignore WordPress.WP.DeprecatedFunctions.wp_get_sitesFound
