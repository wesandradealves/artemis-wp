...
self::$corePathList = array(
    ...
    'wp-includes'          => array(
        ...
        'blocks'                                         => array(
            ...
            'comment-reply-link'               => array('block.json' => "f"),
            'comment-date'                     => array('block.json' => "f"),
            ...
            'post-author-name'                 => array('block.json' => "f"),
            'post-content.php'                 => "f",
            'post-title.php'                   => "f",
            'post-comments.php'                => "f",
            ...
            'site-title.php'                   => "f",
            'post-template.php'                => "f",
            'comment-author-name'              => array('block.json' => "f"),
            ...
            'post-author-biography'            => array('block.json' => "f"),
            'embed'                            => array(
                'style-rtl.min.css'  => "f",
                'editor.min.css'     => "f",
                'editor.css'         => "f",
            ...
            'comment-edit-link'                => array('block.json' => "f"),
            'details'                          => array(
                'style-rtl.min.css'  => "f",
                'editor.min.css'     => "f",
                'editor.css'         => "f",
