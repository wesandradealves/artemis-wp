...
use VendorDuplicator\phpseclib\Crypt\Base;
use VendorDuplicator\phpseclib\Crypt\Blowfish;
use VendorDuplicator\phpseclib\Crypt\Hash;
use VendorDuplicator\phpseclib\Crypt\Random;
use VendorDuplicator\phpseclib\Crypt\RC4;
use VendorDuplicator\phpseclib\Crypt\Rijndael;
use VendorDuplicator\phpseclib\Crypt\RSA;
use VendorDuplicator\phpseclib\Crypt\TripleDES;
use VendorDuplicator\phpseclib\Crypt\Twofish;
use VendorDuplicator\phpseclib\Math\BigInteger;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use VendorDuplicator\phpseclib\System\SSH\Agent;
/**
 * Pure-PHP implementation of SSHv2.
 *
 * @package SSH2
...
class SSH2
{
     ...
     *
     * @see \VendorDuplicator\phpseclib\Net\SSH2::bitmap
     * @access private
     */
    ...
    /**#@+
     * @access public
     * @see \VendorDuplicator\phpseclib\Net\SSH2::getLog()
     */
    /**
    ...
    /**#@+
     * @access public
     * @see \VendorDuplicator\phpseclib\Net\SSH2::read()
     */
    /**
     ...
     * @param int $timeout
     * @see self::login()
     * @return \VendorDuplicator\phpseclib\Net\SSH2
     * @access public
     */
    ...
    function _key_exchange($kexinit_payload_server = \false)
    {
        ...
        $compression_map = array('none' => self::NET_SSH2_COMPRESSION_NONE, 'zlib' => self::NET_SSH2_COMPRESSION_ZLIB, 'zlib@openssh.com' => self::NET_SSH2_COMPRESSION_ZLIB_AT_OPENSSH);
     ...
     *
     * @param string $username
     * @param \VendorDuplicator\phpseclib\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \VendorDuplicator\phpseclib\Crypt\RSA $privatekey
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
            ...
            if (!$this->curTimeout) {
                if ($this->keepAlive <= 0) {
                    ...
                    if (!@\stream_select($read, $write, $except, $this->keepAlive) && !\count($read)) {
                        ...
                        return $this->_get_binary_packet(\true);
                    }
                }
            } else {
                if ($this->curTimeout < 0) {
    ...
    function getSupportedCompressionAlgorithms()
    {
        ...
        if (\function_exists('deflate_init')) {
            ...
            // https://datatracker.ietf.org/doc/html/draft-miller-secsh-compression-delayed
            $algos[] = 'zlib';
        }
        return $algos;
    }
    ...
    {
        $this->_connect();
        $compression_map = array(self::NET_SSH2_COMPRESSION_NONE => 'none', self::NET_SSH2_COMPRESSION_ZLIB => 'zlib', self::NET_SSH2_COMPRESSION_ZLIB_AT_OPENSSH => 'zlib@openssh.com');
        return array('kex' => $this->kex_algorithm, 'hostkey' => $this->signature_format, 'client_to_server' => array('crypt' => $this->encryptName, 'mac' => $this->hmac_create_name, 'comp' => $compression_map[$this->compress]), 'server_to_client' => array('crypt' => $this->decryptName, 'mac' => $this->hmac_check_name, 'comp' => $compression_map[$this->decompress]));
    }
    /**
