...
class DUP_PRO_U
{
    ...
    {
        esc_html_e($text, DUP_PRO_Constants::PLUGIN_SLUG); // phpcs:ignore
    }
    ...
    {
        esc_attr_e($text, DUP_PRO_Constants::PLUGIN_SLUG); // phpcs:ignore
    }
    ...
    {
        return __($text, DUP_PRO_Constants::PLUGIN_SLUG); // phpcs:ignore
    }
    ...
    {
        return _e($text, DUP_PRO_Constants::PLUGIN_SLUG); // phpcs:ignore
    }
    ...
    {
        return esc_html__($text, DUP_PRO_Constants::PLUGIN_SLUG); // phpcs:ignore
    }
